...
## Defining the Load File {#defining_the_load_file}
...
## Defining the Load {#defining_the_load}
...
### Automatic Load Query {#automatic_load_query}
...
### Manual Load Query {#manual_load_query}
...
## Loading the File {#loading_the_file}
...
### Table Load Parameters {#table_load_parameters}
...
### Viewing Load Messages {#viewing_load_messages}
...
### Converting an Excel File to a Tab-delimited Text File for DBLOAD {#converting_an_excel_file_to_a_tab_delimited_text_file_for_dbload}
