...
table for it (see [Tables](Tables "wikilink")).
...
form](Accessing_a_Related_Form#The_Target_Form "wikilink") to be reached
...
status](Form_Column_Attributes#Read-only_Columns "wikilink") to all the
form’s columns.
...
triggers](Built-in_Triggers "wikilink") will be activated.  
...
-   [Creating a Default Design for a
    Form](Creating_a_Default_Design_for_a_Form "wikilink")
