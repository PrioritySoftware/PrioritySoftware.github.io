...
- Priority Software Cloud customers can now [refresh the metadata](../Modify#priority-software-cloud---refreshing-metadata) for entities with private customizations.
