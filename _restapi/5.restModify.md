...
## Deprecated
The following are no longer supported by Odata, for updating multiple related entities and writing ot text forms, [See Performing Batch Operations](#Performing_Batch_Operations).
