...
For more information on $batch, see the official documentation on the [OASIS website](https://docs.oasis-open.org/odata/odata-json-format/v4.01/odata-json-format-v4.01.html#_Toc499716905).
...
## Deprecated
The following features are no longer supported by Odata.

### Updating Multiple Related Entities
[Deprecated]

For updating multiple related entities and writing ot text forms, [See Performing Batch Operations](#Performing_Batch_Operations).
