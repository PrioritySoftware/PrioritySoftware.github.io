...
```
['21.1'](/../restapi/#Features_by_Version)
...
To create an entity if it does not exist, or update it if it does, use the PUT method. Note that the semantics for PUT require **all** properties to be sent, even when updating an existing entity.
