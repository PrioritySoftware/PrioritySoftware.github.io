...
<code>GET serviceRoot/ORDERS?$since=2020-01-01T07:25:00Z</code>

This example would retrieve all orders that were changed since January 1st, 2020, after 7:25 AM UTC.

**Important**: We strongly recommend using UTC timezone format with the **Z** suffix (e.g., `2020-01-01T07:25:00Z`) rather than including a timezone offset. This approach is DST-proof and eliminates issues that can occur during daylight saving time transitions. If you use a timezone offset (e.g., `+02:00` or `+03:00`), you will need to manually adjust the offset whenever daylight saving time changes, as different offsets represent different points in time.
...
<code>GET serviceRoot/ORDERS?$since=2020-01-01T07:25:00Z&$expand=ORDERITEMS_SUBFORM</code>
