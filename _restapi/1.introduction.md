...
interface. You can view details of form definitions and transaction usage in the View License
Details report. Forms that do not appear in the report use regular transactions. Additional
