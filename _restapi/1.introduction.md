...
In order to maintain optimal performance of the API and Priority, each user is limited to a maximum of 100 API calls per minute. Any user sending requests above this rate is considered a delniquent user and will be throttled. While throttled, the user will receive an error response:
