...
The new service root is <code>https://t.eu.priority-connect.online/odata/Priority/tabbtd38.ini/tp</code>. You might have to replace the url in the Postman collection while we work on updating it.
