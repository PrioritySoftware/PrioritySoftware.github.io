...
Consult with your System Administrator if you are not sure what the service root for your installation is. They can output it using the [Send Program Activation Link](priority:priform@MGLINK.P::.:tabula.ini:3) program.
