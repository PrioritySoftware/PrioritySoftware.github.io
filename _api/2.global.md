...
| **Param** | **Type** | **Description** |
| --- | --- | --- |
| LoginFunctions |  [`LoginFunctions`](#LoginFunctions) | LoginFunctions object, that has various methods for retrieving information related to the Priority installation and that API. |
