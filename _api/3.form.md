...
Uploads a file to the server in dataURL format. Can be used both in a parent form and in a sub-form in files fields. Any file type in base64 format is supported, although some file types are blocked by Priority.
