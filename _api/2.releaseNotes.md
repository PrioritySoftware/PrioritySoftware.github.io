 ...
 * The documentation of the Web SDK was originally written in an era where asynchronous javascript was still performed with callbacks and promise chaining. We have overhauled the documentation examples to now use **async await** instead, and removed all the references to success and error callbacks.
