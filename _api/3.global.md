...
**Resolve**: [`LoginFunctions`](../loginFunctions/#LoginFunctions) Object
...
try { 
    await priority.login(config, null, null)
...
| **Param** | **Type** | **Description** |
| --- | --- | --- |
| LoginFunctions |  [`LoginFunctions`](../loginFunctions/#LoginFunctions) | LoginFunctions object, that has various methods for retrieving information about the Priority installation and API . |
