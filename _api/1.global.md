...
### priorityReady()
This method is automatically called by the SDK when it has fully loaded.
Ensure that 'priorityReady' is called **first**, before you start calling any other SDK methods. This is particularly important if you chose to include the SDK via a script (as opposed to npm).
