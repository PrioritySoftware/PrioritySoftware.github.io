...
### priorityReady()
Call this method to verify that the API is loaded and ready for use.
Call 'priorityReady' **first**, before you start calling other SDK methods. This is particularly important if you chose to include the SDK via a script (as opposed to npm).
...
| --- | --- | --- | --- |
| NoHtml | <code>string</code> | <code>&quot;noHtml&quot;</code> | There was an attempt to add text in form which is not for freeform text. |
| ReadOnlyForm | <code>string</code> | <code>&quot;readOnlyForm&quot;</code> | There was an attempt to save text in a read-only form. |
| TextTooLong | <code>string</code> | <code>&quot;textTooLong&quot;</code> | There was an attempt to save text that was too long. |
