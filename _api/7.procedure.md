...
|['client'](#client)| Checked by certain procedures for printing documents. | clientContinue |
...
Certain printing procedures check the client to include certain data. You should always respond with **clientContinue**.
...
##### clientContinue(successCallback, errorCallback)
