...
This function behaves almost identically to the [formStartEx](../api/global/#formStartEx) function for forms, except than rather than specifying the form, you specify the field ID of an input field.
