...
| progressCallback | [`ProcProgressCallback`](#../procedure/#ProcProgressCallback)| Called in case the 'activity' is a heavy operation that takes time. Indicates a progress bar should be shown. |
